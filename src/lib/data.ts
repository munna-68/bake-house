...
export const DEMO_BANNER =
  'DEMO STOREFRONT BY SITEKEEP.STUDIO. BUILD A BOX AND CHECK OUT — NOTHING IS CHARGED AND NO CARD IS TAKEN.'
...
export const FLAVOURS: Flavour[] = [
  {
    ...
    stock: 1,
    photo: `${BASE}/cookies/salted-butter-chip.webp`,
    art: {
      base: '#d8a968',
      edge: '#bd8946',
  ...
  },
  {
    ...
    stock: 12,
    photo: `${BASE}/cookies/triple-chocolate.webp`,
    art: {
      base: '#4a2e1d',
      edge: '#341f11',
  ...
  },
  {
    ...
    allergens: ['Wheat', 'Milk', 'Soy'],
    stock: 15,
    photo: `${BASE}/cookies/caramel-speculoos.webp`,
    art: {
      base: '#c98f4e',
      edge: '#a96f32',
  ...
  },
  {
    ...
    allergens: ['Wheat', 'Milk', 'Egg'],
    stock: 11,
    photo: `${BASE}/cookies/beetroot-red-velvet.webp`,
    art: {
      base: '#8e3b34',
      edge: '#6e2a25',
  ...
  },
  {
    ...
    allergens: ['Wheat', 'Milk', 'Soy'],
    stock: 0,
    photo: `${BASE}/cookies/ceremonial-matcha.webp`,
    art: {
      base: '#93a96a',
      edge: '#76894f',
  ...
  },
  {
    ...
    allergens: ['Wheat', 'Milk', 'Soy'],
    stock: 7,
    photo: `${BASE}/cookies/raspberry-dark.webp`,
    art: {
      base: '#4a2a1e',
      edge: '#341a11',
  ...
  },
  {
    ...
    stock: 6,
    photo: `${BASE}/cookies/peanut-butter-cup.webp`,
    art: {
      base: '#c48a4e',
      edge: '#a36c33',
  ...
  },
  {
    ...
    allergens: ['Wheat', 'Milk', 'Egg'],
    stock: 9,
    photo: `${BASE}/cookies/burnt-marshmallow.webp`,
    art: {
      base: '#c09a6b',
      edge: '#9e7a4c',
  ...
  },
  {
    ...
    stock: 0,
    photo: `${BASE}/cookies/oat-and-cinnamon.webp`,
    art: {
      base: '#c7a97c',
      edge: '#a98a5c',
