    ...
    <section id="build" className="container-page scroll-mt-24 pb-4">
      ...
      <div className="mt-7 grid gap-5 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)] lg:items-start lg:gap-7">
        {/* The panel is taller than a laptop viewport, and `sticky` would pin its
            bottom — including the checkout CTA — permanently below the fold. The
            panel caps its own height and scrolls its body, with the total and CTA
            pinned, so the primary action is reachable at any window size. */}
